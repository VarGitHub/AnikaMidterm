...
public class CsvReader {
   ...
   public static void main(String[] args) {
      ...
      String csvFilePath = "/Users/anikasian/Desktop/PnTNotes/MidtermJanuary2019/src/codelab/status/roster-file-03-02-2019.csv";
      String line = "";
      String cvsSplitBy = ",";
      ...
      System.out.println("--------------------------------\n" +
              "Average number of questions done: " + sum / roster.size());
